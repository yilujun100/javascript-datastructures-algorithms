...
console.log('negativeNumbers.concat(zero, positiveNumbers)', numbers); // ES5 syntax
...
console.log('numbers.some(isEven)', numbers.some(isEven)); // ES5 sintax for function below
...
console.log('numbers.filter(isEven)', numbers.filter(isEven)); // ES5 sintax for function below
